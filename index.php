...
<html lang="en">
    ...
    <body>
        ...
        <div id="main-wrapper">
					...
					<nav id="navigation" class="navigation navigation-landscape">
						...
						<div class="nav-menus-wrapper" style="transition-property: none;">
							<ul class="nav-menu">
								...
								<li><a href="list-full-style-2.html">Search</a></li>
								...
								<li><a href="JavaScript:Void(0);">Features<span class="submenu-indicator"></span></a>
									<ul class="nav-dropdown nav-submenu">
										<li><a href="single-property-2.html">Single Property</a></li>                                    
										...
										<li><a href="agent-grid.html">Agents Search</a></li>
			...
			<!-- ============================ Hero Banner  Start================================== -->
			<div class="image-bg hero-header" style="background:#2540a2 url(assets/img/banner-2.jpg) no-repeat;" data-overlay="0">
				<div class="container">
													...
													<div class="choose-propert-type">
														<ul class="nav nav-pills" role="tablist">
															<li class="nav-item" role="presentation">
																<button class="nav-link active" id="for-rent" data-bs-toggle="tab" data-bs-target="#rents" type="button" role="tab" aria-selected="true">For Rent</button>
															</li>
															<li class="nav-item" role="presentation">
																<button class="nav-link" id="for-buy" data-bs-toggle="tab" data-bs-target="#buys" type="button" role="tab" aria-selected="false">For Buy</button>
															</li>
														</ul>
													</div>
												</div>
							...
							<div class="brand-slide" id="brand-slide">
								...
								<div class="single-brand">
									<figure class="thumb-figure">
										<img src="assets/img/airbnb.png" class="img-fluid" alt="">
									</figure>
								</div>
								...
								<div class="single-brand">
									<figure class="thumb-figure">
										<img src="assets/img/googl.png" class="img-fluid" alt="">
									</figure>
								</div>
								...
								<div class="single-brand">
									<figure class="thumb-figure">
										<img src="assets/img/samsung.png" class="img-fluid" alt="">
									</figure>
								</div>
								
								<div class="single-brand">
									<figure class="thumb-figure">
										<img src="assets/img/slack.png" class="img-fluid" alt="">
									</figure>
								</div>
								
								<div class="single-brand">
									<figure class="thumb-figure">
										<img src="assets/img/spotify.png" class="img-fluid" alt="">
									</figure>
								</div>
			...
			<section class="mid">
				<div class="container">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM `prop_tb_rent`";
                        $query = mysqli_query($conn, $sql);

                        $sqi = "SELECT * FROM `prop_tb_sale`";
                        $quer = mysqli_query($conn, $sqi);
                    ...
                    ?>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							...
							<div class="veshm-list-wraps">
								<div class="veshm-type"><span><?php echo $row['prop_status_rent']; ?></span></div>
								
								<div class="veshm-list-thumb">
									<button type="button" class="compare-btn"><i class="fa-solid fa-repeat"></i>Compare</button>
									<div class="veshm-list-img-slide">
										<div class="veshm-list-click">
											<div><a href="single-property-1.php?id=<?php echo $row['id'];?>"><img src="assets/img/<?php echo $row['prop_img1']; ?>" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.php?id=<?php echo $row['id'];?>"><img src="assets/img/<?php echo $row['prop_img2']; ?>" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.php?id=<?php echo $row['id'];?>"><img src="assets/img/<?php echo $row['prop_img3']; ?>" class="img-fluid mx-auto" alt=""></a></div>
										</div>
									</div>
								</div>
								<div class="veshm-list-block">
									...
									<div class="veshm-list-head">
										<div class="veshm-list-head-caption">
											<div class="rlhc-price">
												<h4 class="rlhc-price-name theme-cl">$<?php echo $row['price']; ?><span class="monthly">/Months</span></h4>
											</div>
											<div class="listing-short-detail-flex">
												<h5 class="rlhc-title-name verified"><a href="single-property-1.php?id=<?php echo $row['id'];?>" class="prt-link-detail"><?php echo $row['prop_name']; ?></a></h5>
												<div class="rlhc-prt-location"><img src="assets/img/pin.svg" width="16" class="me-1" alt=""><?php echo $row['zip_code']; ?> <?php echo $row['prop_address']; ?>, <?php echo $row['state']; ?></div>
											</div>
										</div>
									...
									<div class="veshm-list-footer">
										<div class="veshm-list-circls">
											<ul>
												<li><span class="bed-inf"><i class="fa-solid fa-bed"></i></span><?php echo $row['no_beds']; ?> Beds</li>
												<li><span class="bath-inf"><i class="fa-solid fa-bath"></i></span><?php echo $row['no_bath']; ?> Baths</li>
												<li><span class="area-inf"><i class="fa-solid fa-vector-square"></i></span><?php echo $row['sqft']; ?> Sft</li>
											</ul>
										</div>
									</div>
								</div>
						...
						<!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="veshm-list-wraps">
								...
								<div class="veshm-list-thumb">
									...
									<div class="veshm-list-img-slide">
										<div class="veshm-list-click">
											<div><a href="single-property-1.html"><img src="assets/img/prt-2.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-11.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-10.png" class="img-fluid mx-auto" alt=""></a></div>
										</div>
									</div>
								</div>
								<div class="veshm-list-block">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							...
							<div class="veshm-list-wraps">
								<div class="veshm-type fr-sale"><span><?php echo $roww['prop_status_sale']; ?></span></div>
								
								<div class="veshm-list-thumb">
									<button type="button" class="compare-btn"><i class="fa-solid fa-repeat"></i>Compare</button>
									<div class="veshm-list-img-slide">
										<div class="veshm-list-click">
											<div><a href="single-property-1.php?id=<?php echo $roww['id'];?>"><img src="assets/img/prt-3.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.php?id=<?php echo $roww['id'];?>"><img src="assets/img/prt-11.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.php?id=<?php echo $roww['id'];?>"><img src="assets/img/prt-13.png" class="img-fluid mx-auto" alt=""></a></div>
										</div>
									</div>
								</div>
								<div class="veshm-list-block">
									...
									<div class="veshm-list-head">
										<div class="veshm-list-head-caption">
											<div class="rlhc-price">
												<h4 class="rlhc-price-name theme-cl">$<?php echo $roww['price']; ?></h4>
											</div>
											<div class="listing-short-detail-flex">
												<h5 class="rlhc-title-name verified"><a href="single-property-1.php?id=<?php echo $roww['id'];?>" class="prt-link-detail"><?php echo $roww['prop_name']; ?></a></h5>
												<div class="rlhc-prt-location"><img src="assets/img/pin.svg" width="16" class="me-1" alt=""><?php echo $roww['zip_code']; ?> <?php echo $roww['prop_address']; ?>, <?php echo $roww['prop_city']; ?></div>
											</div>
										</div>
										<div class="veshm-list-head-flex">
											<button class="btn btn-like" type="button"><i class="fa-solid fa-heart-circle-check"></i></button>	
									...
									<div class="veshm-list-footer">
										<div class="veshm-list-circls">
											<ul>
												<li><span class="bed-inf"><i class="fa-solid fa-bed"></i></span><?php echo $roww['no_beds']; ?> Beds</li>
												<li><span class="bath-inf"><i class="fa-solid fa-bath"></i></span><?php echo $roww['no_bath']; ?> Baths</li>
												<li><span class="area-inf"><i class="fa-solid fa-vector-square"></i></span><?php echo $roww['sqrt']; ?> Sft</li>
											</ul>
										</div>
									</div>
								</div>
						...
						<!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="veshm-list-wraps">
								...
								<div class="veshm-list-thumb">
									...
									<div class="veshm-list-img-slide">
										<div class="veshm-list-click">
											<div><a href="single-property-1.html"><img src="assets/img/prt-4.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-13.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-15.png" class="img-fluid mx-auto" alt=""></a></div>
										</div>
									</div>
								</div>
								<div class="veshm-list-block">
						...
						<!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="veshm-list-wraps">
								...
								<div class="veshm-list-thumb">
									...
									<div class="veshm-list-img-slide">
										<div class="veshm-list-click">
											<div><a href="single-property-1.html"><img src="assets/img/prt-5.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-10.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-14.png" class="img-fluid mx-auto" alt=""></a></div>
										</div>
									</div>
								</div>
								<div class="veshm-list-block">
						...
						<!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="veshm-list-wraps">
								...
								<div class="veshm-list-thumb">
									...
									<div class="veshm-list-img-slide">
										<div class="veshm-list-click">
											<div><a href="single-property-1.html"><img src="assets/img/prt-6.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-14.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-10.png" class="img-fluid mx-auto" alt=""></a></div>
										</div>
									</div>
						...
						<!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="veshm-list-wraps">
								...
								<div class="veshm-list-thumb">
									...
									<div class="veshm-list-img-slide">
										<div class="veshm-list-click">
											<div><a href="single-property-1.html"><img src="assets/img/prt-7.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-11.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-13.png" class="img-fluid mx-auto" alt=""></a></div>
										</div>
									</div>
						...
						<!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="veshm-list-wraps">
								...
								<div class="veshm-list-thumb">
									...
									<div class="veshm-list-img-slide">
										<div class="veshm-list-click">
											<div><a href="single-property-1.html"><img src="assets/img/prt-8.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-15.png" class="img-fluid mx-auto" alt=""></a></div>
											<div><a href="single-property-1.html"><img src="assets/img/prt-11.png" class="img-fluid mx-auto" alt=""></a></div>
										</div>
									</div>
							...
							<div class="side-slide">
								...
								<div class="single-slide">
									<div class="veshm-agent-wrap">
										...
										<div class="veshm-agent-thumb">
											<img src="assets/img/user-6.png" class="img-fluid circle" alt="">
										</div>
										<div class="veshm-agent-content">
